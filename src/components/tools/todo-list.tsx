...
import { Trash2, Pencil, CheckSquare, Calendar as CalendarIcon, Check } from "lucide-react";
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            >
              ...
              <SelectContent>
                {[
                  { value: "high", color: "bg-red-500", label: "High", desc: "Urgent task" },
                  {
                    value: "medium",
                    color: "bg-yellow-500",
                    label: "Medium",
                  ...
                  { value: "low", color: "bg-green-500", label: "Low", desc: "Nice to have" },
