      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">The date from which to calculate backwards</p>
          </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Based on being {currentAge} {ageUnit} old on {new Date(referenceDate).toLocaleDateString()}, the
                calculated date of birth is {result.formattedDOB}.
              </p>
            </div>
          </CardContent>
        </Card>
