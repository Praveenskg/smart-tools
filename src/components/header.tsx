      ...
      <div className='relative container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          >
            ...
            >
              {/* Glow effect */}
              <div className='absolute inset-0 rounded-xl bg-gradient-to-br from-indigo-400 via-purple-400 to-pink-400 opacity-0 blur-md transition-opacity duration-300 group-hover:opacity-75' />
            ...
            <div className='flex flex-col leading-tight'>
              <motion.span
                className='bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-xl font-bold tracking-tight text-transparent transition-all duration-300 group-hover:from-indigo-500 group-hover:via-purple-500 group-hover:to-pink-500 sm:text-2xl'
